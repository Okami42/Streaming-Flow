// Types g̩n̩riques pour tous les contenus
export interface Episode {
  id: number;
  title: string;
  videoUrl: string;
  duration?: number; // Dur̩e en secondes
  imageUrl?: string; // URL de l'image de l'̩pisode
}
...
export interface Content {
  ...
  seasonsList?: Season[];  // Liste d̩taill̩e des saisons
  runtime?: string;  // Uniquement pour les films
}

// Types sp̩cifiques pour les animes
