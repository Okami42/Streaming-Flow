...
export const animes: Anime[] = [
  ...
  },
  {
    ...
    title: "The Witch and the Beast",
    originalTitle: "ある魔女が死ぬまで",
    description: "Guideau est une jeune femme au tempérament violent qui cache un terrible secret : elle a été maudite par une sorcière et transformée. Accompagnée d'Ashaf, un magicien énigmatique, elle parcourt le monde à la recherche de sorcières pour briser sa malédiction. Leur voyage les mène dans des villes où la magie et l'humanité coexistent dans un équilibre précaire. Entre vengeance personnelle et justice, Guideau découvre que le monde des sorcières est plus complexe qu'elle ne l'imaginait, et que sa quête pourrait avoir des conséquences qu'elle n'avait pas prévues.",
    imageUrl: "",
    bannerUrl: "/picture/bassembanniere.png",
    year: 2024,
    type: "Anime",
    status: "En cours",
    genres: ["Action", "Fantastique", "Drame", "Magie", "Vengeance", "Sorcières"],
    rating: 7.8
  },
  {
