  ...
  return (
    <html lang="fr" suppressHydrationWarning className={`${inter.variable}`}>
      <head>
          ...
          if (window.top !== window.self) {
            ...
            try {
              ...
              window.open = function(url, target, features) {
                // Bloquer les popups si l'URL contient movearnpre
                if (url && url.includes('movearnpre')) {
        ...
        {/* Bloqueur spécifique pour movearnpre.com */}
        <script dangerouslySetInnerHTML={{
          __html: `
            // Bloquer les popups et redirections pour movearnpre.com
