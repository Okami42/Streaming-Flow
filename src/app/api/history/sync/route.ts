...
import { verifyToken, getUserHistory, syncUserHistory, clearUserHistory, initializeDatabase } from '@/lib/database';
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const message = error instanceof Error ? error.message : 'Erreur de suppression de l\'historique';
    const status = message.includes('invalide') ? 401 : 500;
